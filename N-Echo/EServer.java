...
public class EServer {
	public static void main(String[] args) throws IOException {
        ...
        try{
            ...
            while(true){
                String inputMessage = dis.readUTF();    //클라이언트로부터 한 행 읽기
                ...
                char ch = inputMessage.charAt(0);
                int t = Character.getNumericValue(ch);
				String Message = outputMessage.substring(1);
                String Message2 = Message.repeat(t+1);
                dos.writeUTF(Message2);   //키보드에서 읽은 문자열 전송
